          ...
          >
            <h2 className="mobile-text-3xl s25:text-4xl md:text-4xl lg:text-5xl font-bold leading-tight text-center short-screen-title">
              ...
              <span className="block text-white md:hidden">
                YOUR{" "}
                <span className="animate-gradient-yellow-orange font-bold">
                  VISION
                </span>
              </span>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="relative">
                      ...
                      <div className="relative flex flex-col items-center">
                        ...
                        >
                          <MapPin
                            className="w-8 h-8 md:w-12 md:h-12 text-orange-500 drop-shadow-lg"
                            fill="#f59e0b"
                          />
                          {/* Pulse effect */}
            ...
            >
              <div className="space-y-3 md:space-y-4 text-gray-300 text-justify md:text-center">
                <p className="text-sm md:text-sm leading-relaxed">
                  Creative production house established in 2019, based in Batu
                  Malang, East Java. We combine innovative ideas with
                  exceptional execution to deliver high-quality photography,
                  videography, graphic design, and motion graphics.
                </p>

                <p className="text-sm md:text-sm leading-relaxed">
                  We offer a comprehensive suite of services to bring your
                  vision to life. From stunning photography and captivating
                  videography to impactful graphic design and dynamic motion
                  graphics, we create visuals that tell your brand story and
